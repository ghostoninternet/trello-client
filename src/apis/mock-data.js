...
export const mockData = {
  board: {
    ...
    columnOrderIds: ['column-id-03', 'column-id-02', 'column-id-01', 'column-id-04'], // Thứ tự sắp xếp / vị trí của các Columns trong 1 boards
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        ...
        cards: [
          {
            ...
            cover: 'https://i.ytimg.com/vi/8xYsXrsc75I/maxresdefault.jpg',
      ...
      // Front-end will create a special card: Placeholder Card, have no relation to Back-end
      // This special card will be hidden in UI
      // Special card Id will be very simple: "columnId-placeholder-card"
      // This special card must have: _id, boardId, columnId, FE_Placeholder
      {
        _id: 'column-id-04',
        boardId: 'board-id-01',
